...
2. Click the big green "Code" button in the top right of the page, then click "[Download ZIP](https://github.com/milaan9/12_Python_Seaborn_Module/archive/refs/heads/main.zip)".
